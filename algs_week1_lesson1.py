...
##    3.sort
##    4.binary search
##    5.mean,median,mode,weighted mean,geometrik mean
...
my_list=get_n_random_numbers(12,-100,50)
my_list

#HİSTOGRAM WITH TWO METHODS
...
def my_mode_with_dict(my_hist_d):
    ...
    frequency_max=-1 #mode degeri,döngüde karşılaştırılacak hafıza amaçlı değer
    mode=-1
    for key in my_hist_d.keys():
        #print(key,my_hist_d[key])
        if my_hist_d[key]>frequency_max:
